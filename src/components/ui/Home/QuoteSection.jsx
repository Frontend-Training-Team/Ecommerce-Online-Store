function QuoteSection() {
  return (
    <section className="bg-[#E4E4E4] py-16 dark:bg-[#12100E]">
      <div className="mx-auto max-w-fit px-4 sm:px-6">
        <div className="mb-8">
          <p className="mb-2 mx-auto max-w-300 sm:max-w-330 text-2xl sm:text-4xl italic text-center font-['Source_Serif_4']  text-[#A4775B] dark:text-[#C99A78]">
