...
export default function OrderSummary({ cartItems = [], subtotal = 0, shipping = 50, tax = 0, total = 0, isSubmitting = false, onPlaceOrder }) {
  return (
    <div className="bg-white p-6 rounded-2xl shadow-sm border border-[#f0eae1] space-y-5 sticky top-6">
      <h2 className="text-lg font-bold text-[#2d2421] pb-3 border-b border-[#f5efe6]">
        Order Summary
      </h2>
      ...
      <div className="border-t border-[#f5efe6] pt-4 space-y-2.5 text-xs text-[#736358]">
        ...
        <div className="border-t border-[#f5efe6] pt-3 flex justify-between text-sm font-bold text-[#2d2421]">
          <span>Total</span>
