export function ProductCardSkeleton() {
  ...
  return (
    <div className="h-fit w-fit bg-white dark:bg-[#181412] border-2 border-gray-200 dark:border-[#2e2724] rounded-xl p-2.5 animate-pulse group">

      <div className="relative h-82.5 w-82.5">
        <div
          className="relative h-82.5 w-82.5 bg-gray-200 dark:bg-[#221d1a]"
        ...
        <div className="absolute bottom-2 left-2 w-12.5 h-12.5 bg-gray-300 dark:bg-[#3a322d] rounded-xl shadow-xs
        border-none dark:border-[#2e2724] z-10 flex flex-col items-center justify-center gap-1">
          <div className="rounded bg-gray-400 dark:bg-[#4a423d]" />
        </div>
