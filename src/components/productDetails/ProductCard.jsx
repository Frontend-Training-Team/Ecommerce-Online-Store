    ...
    <div className="h-fit w-fit bg-white border-2 border-gray-200 rounded-xl p-2.5 group">
      ...
      <div className="relative h-[330px] w-[330px]">
        <Link
          ...
          className="block h-[330px] w-[330px]"
        >
          <div
            className="relative h-[330px] w-[330px] bg-amber-600 transition-transform duration-300 group-hover:scale-[1.01]"
            style={{
              clipPath: customPath,
        ...
        text-Inter font-semibold tracking-wider absolute top-4 left-4 pointer-events-none max-w-[130px] truncate shadow-xs">
        ...
        <div className="absolute top-4 right-4 flex items-center gap-1.5 pointer-events-none z-10">
          ...
          text-Inter font-semibold tracking-wider shadow-xs max-w-[110px] truncate">
            <span>{product.brand || "BRAND"}</span>
          </div>
        </div>

        <div className="absolute bottom-2 left-2 bg-white rounded-xl shadow-xs border border-gray-100/80 w-[50px] h-[50px] 
        ...
        <div className="absolute bottom-0 right-0 grid h-fit w-fit grid-cols-2 gap-2 z-10">
          ...
          <button
            ...
            aria-label="Wishlist"
            className={`flex h-[54px] w-[54px] items-center justify-center rounded-xl transition-all cursor-pointer 
            ${isWish
          ...
          <button
            ...
            className="flex h-[54px] w-[54px] items-center justify-center rounded-xl bg-gray-200 text-black 
      ...
      <div className="text-center mt-5 mb-3 max-w-[330px]">
        <Link
          to={`/products/${product._id}`}
          onClick={() => window.scrollTo({ top: 0, behavior: "smooth" })}
          className="block"
