...
function WishlistCard() {
    const customPath = ['path("M 16 0 L 364 0 A 16 16 0 0 1 380 16 L 380 294 A 16 16 0 0 1 364 310 L 326 310 A 16 16 0 0 0 310 326 L 310 364 A 16 16 0 0 1 294 380 L 16 380 A 16 16 0 0 1 0 364 L 0 16 A 16 16 0 0 1 16 0 Z")'];
    ...
    return (
        <div className="h-fit w-fit bg-white border-2 border-gray-200 rounded-2xl p-2.5">
            <div className="relative h-[380px] w-[380px]">
                ...
                <div className="absolute bottom-0 right-0 grid h-[60px] w-[60px] grid-cols-2 gap-2.5">
                    <button className="flex h-[60px] w-[60px] items-center justify-center rounded-2xl bg-gray-200 text-black">
                        <Trash color="#FF0000" strokeWidth={1.5} />
                    </button>
                </div>
            </div>
