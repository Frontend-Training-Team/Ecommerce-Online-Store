  ...
  return (
    <div className="min-h-screen bg-[#faf8f5] flex flex-col items-center justify-center p-4 font-sans text-center">
      ...
      <div className="flex flex-col sm:flex-row items-center justify-center gap-3 w-full max-w-xs sm:max-w-none">
        ...
        <Link
          to="/orders"
          className="w-full sm:w-auto px-5 py-2.5 rounded-xl border border-[#c07a50]
           bg-transparent text-[#c07a50] hover:bg-[#c07a50]/5 font-semibold text-xs flex items-center justify-center
        ...
        <Link
          to="/"
          className="w-full sm:w-auto px-5 py-2.5 rounded-xl bg-[#c07a50] hover:bg-[#ad6a42] text-white font-semibold text-xs
